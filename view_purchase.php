...
// Get purchase data
 $sql = "SELECT p.id, p.purchase_date, p.total_amount, s.name AS supplier_name, s.address, s.phone, s.email, u.name AS user_name 
        FROM purchases p 
...
// Get purchase details
 $purchase_details = [];
 $sql = "SELECT pd.id, pd.quantity, pd.unit_price, p.name AS product_name, p.brand, p.model 
...
<head>
    ...
    <title>View Purchase - TV Inventory System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <span class="navbar-brand">Purchase Details</span>
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>Purchase #<?php echo $purchase['id']; ?></h2>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Buyer:</strong> <?php echo $purchase['user_name']; ?></p>
                        <p><strong>Total Amount:</strong> Rp <?php echo number_format($purchase['total_amount'], 0, ',', '.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Email:</strong> <?php echo $purchase['email']; ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><strong>Rp <?php echo number_format($purchase['total_amount'], 0, ',', '.'); ?></strong></td>                            </tr>
                        </tfoot>
                    </table>
                </div>
            </div>

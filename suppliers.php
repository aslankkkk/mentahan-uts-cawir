...
<head>
    ...
    <title>Suppliers - TV Inventory System</title>
                    ...
                    <?php else: ?>
                        <?php foreach($suppliers as $supplier): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_supplier.php?id=<?php echo $supplier['id']; ?>" class="btn btn-info btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="suppliers.php?delete=<?php echo $supplier['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this supplier?');">
